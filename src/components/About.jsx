    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='py-2 text-gray-600 dark:text-gray-100'>
                    My interest for programming sparked at SCU after excelling in several computer science classes, such as object oriented programming and data structures, all in the language of C++. I continued to challenge myself and expand my knowledge of software engineering by learning JavaScript, HTML, CSS, frameworks such as React.js, Next.js, and Tailwind CSS, backend and middleware such as Python, Node.js, and Express.js.
                </p>
                <p className='py-2 text-gray-600 dark:text-gray-100'>
                    In the past year, I have worked as a sales and product designer boosting my communication and problem solving skills. I was a TA for an upper-division advanced macroeconomics course, tutoring students in my office hours, coordinating and leading study sessions, and giving lectures to review important course material. For a year, I worked as a service desk assistant at two of SCU's residence halls, leading and coordinating community-focused events, as well as providing technical and other various services. I was also co-lighting designer and spot coordinator/leader for many years at a performing arts venue.
                </p>
                <p className='py-2 text-gray-600 dark:text-gray-100'>
