    ...
    <div id='home' ref={ref} className='w-full h-full pt-[9rem] text-center bg-gradient-radial dark:bg-gradient-radial-dark animate-gradient-x'>
        ...
        <div id="projects" data-aos='fade' data-aos-duration={500} data-aos-delay={500} data-aos-offset={0} className='w-full h-full pt-[9rem] sm:pt-[8rem] md:pt-[6rem] lg:pt-[2.5rem] overflow-hidden flex flex-col items-center'>
            ...
            <div className='relative w-full h-[20rem] lg:h-[34rem] flex justify-center'>
                ...
                <Link href={'/climbersEye'} className='bg-[#FFFFFF] transition ease-in-out hover:bg-[#F7FFF7] hover:shadow-2xl duration-500 group absolute w-[20rem] sm:w-[95%] h-full overflow-hidden rounded-3xl lg:rounded-[4rem] flex justify-center'>
                    ...
                    <div data-aos='fade' data-aos-duration={500} data-aos-offset={50} data-aos-once={true} className='w-[26rem] h-full absolute sm:relative left-14 sm:left-0 transition ease-in-out group-hover:translate-y-5 duration-500 justify-center flex items-center'>
                        <Image priority src='/images/climbers-eye-icon-big.png' alt='climbers eye logo' width={710} height={60} className='transition ease-in-out group-hover:translate-y-5 duration-500' />
                    </div>
                </Link>
            </div>
            {/* wordle module */}
