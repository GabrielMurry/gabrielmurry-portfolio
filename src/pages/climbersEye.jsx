            ...
            <div className='w-full md:w-[50%] h-full space-y-8'>
                ...
                <div className='space-y-5'>
                    ...
                    <div className='flex space-x-5'>
                        ...
                        <Image priority src='/images/climbersEye/CE_9.png' alt='wordle mobile' width={175} height={850} unoptimized className='lg:w-[17rem] xl:w-[20rem] rounded-[1.5rem] lg:rounded-[2.75rem] xl:rounded-[3.25rem] shadow-2xl' />
                    </div>
                    <div className='flex space-x-5'>
